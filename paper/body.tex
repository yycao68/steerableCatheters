...
\item \emph{Corrective-force limiting.} With identical approach RMS, adding the pointwise $|F_{\text{mpc}}|\le0.5$\,N limit reduces measured peak tissue force from 0.595 to 0.467\,N. This isolates the value of explicit force-command limiting for the tested penetrating reference.\footnote{A supplementary video renders the unconstrained and force-constrained controllers side by side on the identical approach-press-hold-retract task: the unconstrained controller's contact force visibly crosses the 0.5\,N line while the constrained controller's does not, reproducing this 0.595 vs 0.467\,N result on the rendered episode.}
